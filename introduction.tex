...
In general, assumptions about some smoothness of given functions (e.g. differentiable enough times) 
is sometimes beneficial in numerical calculation to apply some algorithm or to analyze simply.
However it is not theoretical meaning but only experimental,
it has been not discussed enough about the effect of assumptions about smoothness on how complex can the solution be in terms of Computable Complexity.
