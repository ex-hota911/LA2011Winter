...
We write $\classC^k$ for the set of $k$-times continuously differentiable functions.
...
We write $\classC^{(i,j)}$ for the set of $(i, j)$-times continuously  differentiable functions.
When a function $g$ is in $\classC^{(i,j)}$,
