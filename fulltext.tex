...
\author[A.~Kawamura]{Akitoshi Kawamura}  % \address{University of Tokyo}
\author[H.~Ota]{Hiroyuki Ota}            % has left the University of Tokyo in April 2013
\author[C.~R\"osnick]{Carsten R\"osnick} % \address{Technische Universit\"at Darmstadt}
\author[M.~Ziegler]{Martin Ziegler}      % \address{Technische Universit\"at Darmstadt}
