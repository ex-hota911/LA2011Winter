...
それぞれ式\eqref{eq:initial value}, \eqref{eq:divp}に対応しており, 
...
\begin{align*}
 ...
 \\
 \quantC_{k+1} \classP &= \classPP^{\quantC_k \classP}
 \\
 \classCH &= \bigcup_k \quantC_k \classP.
\end{align*}
...
まず各階層 $\quantC_n \classP$ に対する完全問題$\quantC_n B_{be}$を導入する.
...
$(\quantC_n B_{be})_n$ をまとめた言語 $\quantC_{\log} B_{be}$ を以下のように定義する.
\begin{equation}
