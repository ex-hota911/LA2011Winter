...
Since The only terms that can survive are those that 
$V_{[1, s_i+1]} = 10 \cdots 0$ and
$V$ is between $\overline{T_{s_n} \dots T_{s_{i+1}+1} 00 \dots 0}$ and 
$\overline{T_{s_n} \dots T_{s_{i+1}+1} 01 \dots 1}$.
This proves $H_u(i+1, T) \in [2^{l_i}]$ since these terms are all $0$ or $1$.
