...
SRC=abstract.euc.tex conclusion.euc.tex proof.euc.tex introduction.euc.tex preliminary.euc.tex acknowledgements.euc.tex constructive.euc.tex future.euc.tex
#スタイルファイルやクラスファイルなど
OHTERS=
# 画像などのバイナリファイル
IMG=
